        ...
        <div>
            ...
            <form class="form-horizontal" style="padding: 1.875rem;" name="register" id="register">
                <div class="form-group">
                    <label for="type" class="col-md-4 control-label">修改后的类型</label>
                    <div class="col-md-8">
                ...
                <div class="form-group">
                    <div class="col-md-5 col-md-offset-5">
                        <button type="submit" class="btn btn-default" id="button2">修改</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        $("#button2").click(function () {
            $.ajax({
                ...
                success: function (data) {
                    if (data.code === 0) {
                        window.location.href = '/type/get?page=1'
                        alert("修改成功")
                    } else {
                        alert(data.msg)
                    }
